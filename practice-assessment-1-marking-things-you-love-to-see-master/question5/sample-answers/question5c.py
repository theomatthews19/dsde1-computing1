...
def max_min(input_list, operation = None):
    ...
    #check if the input_list is a list 
    if isinstance(input_list, list) == True:

        #if operation is 'max', return the max value from the list 
        if operation == 'max': 
            return max(input_list)
        
        #if operation is 'min', return the min value from the list 
        if operation == 'min': 
            return min(input_list)

        #if operation is not specified, return the max value from the list 
        elif operation == None: 
            return max(input_list)

        #if operation is specified but not 'max' or 'min, return the max value from the list 
        else: 
            return None
